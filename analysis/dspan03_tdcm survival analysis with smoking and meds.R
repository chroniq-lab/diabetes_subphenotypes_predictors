...
write_csv(unpooled_resuts, paste0(path_diabetes_subphenotypes_predictors_folder,"/working/processed/dspan03_unpooled tdcm results with smoking and medications.csv"))
...
tdcm_results <- bind_rows(
  ...
  write_csv(paste0(path_diabetes_subphenotypes_predictors_folder,"/working/processed/dspan03_pooled tdcm results with smoking and medications.csv"))
